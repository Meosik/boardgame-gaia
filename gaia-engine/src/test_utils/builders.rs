    ...
    pub fn build(self) -> GameState {
        ...
        GameState {
            ...
            terraforming_color_order: vec![
                crate::game_state::PlanetType::Terra,
                crate::game_state::PlanetType::Swamp,
                crate::game_state::PlanetType::Desert,
                crate::game_state::PlanetType::Oxide,
                crate::game_state::PlanetType::Titanium,
                crate::game_state::PlanetType::Volcanic,
                crate::game_state::PlanetType::Ice,
            ],
...
pub fn minimal_player(player_id: u8) -> PlayerState {
    PlayerState {
        ...
        expensive_terraforming_planet_types: vec![],
...
fn empty_research_board() -> ResearchBoard {
    ...
    ResearchBoard {
        ...
        lost_fleet_advanced_tech_requirement: Default::default(),
        terraforming_level_5_token: None,
        federation_tokens: vec![],
        economy_research_tile_side: Default::default(),
    }
}
